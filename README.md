...
* 场景组件&交互：
  ...
  - [x] 根据表面应用摩擦力
  - [ ] 翻牌显示器
  - [ ] 蜡烛数量触发器 #烛火是数字，红色的是敌人，蓝色的是场景组件破坏，归零触发门和机关
  - [ ] 门
  - [ ] 按钮
  - [ ] 压力板
  - [ ] 椰子和椰子树  #某种保龄球
...
* NPC & 敌人：
  ...
  * 重型
    - [ ] 鬼魂 Ghost  #附身到特定物体
    - [ ] 障目天使雕像 Blind Angel Statue  #雕像在你视线内高速滑动并无敌，视线外静止、可以挨打了 Blind Angel Statue
  * 超重型
    - [ ] 鹿颈长 Effarig  #柱形搭路机
  * Boss
