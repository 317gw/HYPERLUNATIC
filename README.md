...
引擎版本会激进跟随最新稳定版 —— Godot_v4.4-beta3
...
assets文件夹下的部分代码和资源文件、图像、音频来自网络，对其进行了修改，遵守其协议，并尽可能的表明了出处。
